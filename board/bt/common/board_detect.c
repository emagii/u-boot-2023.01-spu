...
static const char *board_rev = "board_rev";
static const char *board_serial = "board_serial";
...
void __maybe_unused set_board_info_env(char *name)
{
	...
	if (name)
		...
		env_set(board_name, CONFIG_BOARD_NAME);
#else
...
#if	defined(CONFIG_BOARD_REV)
		env_set(board_rev, CONFIG_BOARD_REV);
#else
...
#if	defined(CONFIG_BOARD_SERIAL)
		env_set(board_serial, CONFIG_BOARD_SERIAL);
#else
